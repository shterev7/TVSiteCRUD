...
if ($errMsg)
{
	...
	echo "<a href='insert_tv.php'>Ново въвеждане</a>";
}
else
{
	$mysqli=new mysqli(dbHost, dbUser, dbPasswd, dbName);
		...
		$str_query="INSERT INTO tbl_tvs(id_make,price,moreinfo) VALUES ('"
		...
		if($result)
		{
			...
			if (in_array($ext, $allowedExt) && ($_FILES["imgFile"]["size"] <200000))
			{
				...
				"pictures/".$picName);
				$StrQuery="update tbl_tvs set pictures='".$picName."' where
				id_tv=".$idTv;
